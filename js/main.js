...
const channels = [
    { id: '8mei6uVttho', name: 'Introdução a Algoritmos' },
    { id: 'M2Af7gkbbro', name: 'Primeiro Algoritmo' },
    { id: 'RDrfZ-7WE8c', name: 'Comando de Entrada e Operadores' },
    { id: 'Ig4QZNpVZYs', name: 'Operadores Lógicos e Relacionais' },
    { id: 'GrPkuk1ezyo', name: 'Introdução ao Scratch' },
    { id: 'v2nCgGSVCeE', name: 'Exercícios de Algoritmo Resolvidos' },
    { id: '_g05aHdBAEY', name: 'Estruturas Condicionais 1' },
    { id: '7gGFHzqh4d8', name: 'Estruturas Condicionais 2' },
    { id: 'U5PnCt58Q68', name: 'Estruturas de Repetição 1' },
    { id: 'fP49L1i_-HU', name: 'Estruturas de Repetição 2' },
    { id: 'WJQz20i7CyI', name: 'Estruturas de Repetição 3' },
    { id: 'KoNehy7rn8U', name: 'Procedimentos' },
    { id: '-nNx7e8GzHQ', name: 'Funções' },
    { id: 'j9473xQ39vY', name: 'Vetores' },
    { id: 'hkE9WrjpAAk', name: 'Matrizes' }
];
